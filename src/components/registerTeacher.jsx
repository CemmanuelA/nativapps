...
import { saveTeacher } from '../config';
...
class RegisterTeacher extends React.Component{
    ...
    handleSubmit(event){
        ...
        if(nombre == '' || apellido == '' || genero == '' || identificacion == ''){
            ...
            saveTeacher(identificacion,nombre,apellido,genero);
        ...
        return(<div>
                ...
                <Button className="btn-regresar"><Link to="/">Regresar</Link></Button>
                    <FormGroup className="contenido">
                        ...
                        <FormControl name='identificacion' type="text" value={this.state.identificacion} placeholder="Identificación del profesor" 
                        onChange={this.handleChange}/>
                        
                        <ControlLabel>Nombre</ControlLabel>
                        <FormControl name='nombre' type="text" value={this.state.nombre} placeholder="Nombre del profesor" 
                        onChange={this.handleChange}/>
                        
                        <ControlLabel>Apellido</ControlLabel>
                        <FormControl name='apellido' type="text" value={this.state.apellido} placeholder="Apellido del profesor" 
                        onChange={this.handleChange}/>

                        <ControlLabel>Género</ControlLabel>
                        <FormControl name='genero' type="text" value={this.state.genero} placeholder="Genero del eprofesor" 
                        onChange={this.handleChange}/>
